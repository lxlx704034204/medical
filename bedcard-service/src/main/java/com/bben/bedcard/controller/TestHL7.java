...
import com.bben.common.Hl7Util.HL7Helper;
import com.bben.common.Hl7Util.UserDefineComposite;
import com.bben.common.Hl7Util.UserDefineMessage;
...
public class TestHL7 {
    ...
    public void hl7Text2Obj(String responseStr) {
        ...
        try {
            ...
            System.out.println("MSH1="+msh.encode());
            System.out.println("MSH2="+msh.getDateTimeOfMessage().getTs1_TimeOfAnEvent().toString());

            QPD qpdt = (QPD) udm2.get("QPD");
            System.out.println("QPD1="+qpdt.encode());
            System.out.println("QPD2="+qpdt.getQpd1_MessageQueryName().getCe1_Identifier().getValue());
            System.out.println("QPD3="+HL7Helper.getMsgValue(udm2, "QRI", 1,0,0));

            System.out.println("============hl7Text2Obj>"+udm2.encode());
        } catch (Exception e) {
